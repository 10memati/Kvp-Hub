...
local aws = "13127800756" -- Arm Wrestle Simulator
function hata(text)
...
elseif tostring(game.placeId) == tostring(los) then
    loadstring(game:HttpGet("https://raw.githubusercontent.com/10memati/Kvp-Hub/main/games/armwrestlesimulator.lua"))()
    ok('Successfully loaded for Arm Wrestle Simulator!')
else
